...
export type DonationOrganizationDocument =
  HydratedDocument<DonationOrganization>;
...
export const DonationOrganizationSchema =
  SchemaFactory.createForClass(DonationOrganization);
